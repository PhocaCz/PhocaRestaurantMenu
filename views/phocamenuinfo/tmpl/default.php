...
echo '<div id="j-main-container" class="span9">'
	...
	.'<h3>'.JText::_($this->t['l'].'_PHOCA_RESTAURNT_MENU').' - '. JText::_($this->t['l'].'_INFORMATION').'</h3>'
...
.'<div class="btn-group">
<a class="btn btn-large btn-default" href="http://www.phoca.cz/version/index.php?'.$this->t['c'].'='.  $this->t['version'] .'" target="_blank"><i class="icon-loop icon-white"></i>&nbsp;&nbsp;'.  JText::_($this->t['l'].'_CHECK_FOR_UPDATE') .'</a></div>';
