...
echo '<th class="ph-category">'.JHTML::_('searchtools.sort',  $this->t['l'].'_TYPE', 'a.type', $listDirn, $listOrder ).'</th>'."\n";
echo '<th class="ph-category">'.JHTML::_('searchtools.sort',  $this->t['l'].'_DAY', 'day.title', $listDirn, $listOrder ).'</th>'."\n";
echo '<th class="ph-category">'.JHTML::_('searchtools.sort',  $this->t['l'].'_LIST', 'list.title', $listDirn, $listOrder ).'</th>'."\n";
echo '<th class="ph-category">'.JHTML::_('searchtools.sort',  $this->t['l'].'_GROUP', 'c.title', $listDirn, $listOrder ).'</th>'."\n";
