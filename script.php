...
{
    protected $extension 	= 'com_phocamenu';
    protected $updatetext 	= 'COM_PHOCAMENU_UPDATE_TEXT';
    protected $installtext 	= 'COM_PHOCAMENU_INSTALL_TEXT';
    protected $versiontext	= 'COM_PHOCAMENU_VERSION';
    protected $extensiontext= 'COM_PHOCAMENU';
    protected $configuretext= 'COM_PHOCAMENU_CONFIGURE';
