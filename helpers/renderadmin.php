...
class PhocaMenuRenderAdmin
{
	...
	public static function getLinks() {
		...
		switch ($option) {
			case 'com_phocamenu':
				$links[]	= array('Phoca Restaurant Menu site', 'http://www.phoca.cz/phocamenu');
				$links[]	= array('Phoca Restaurant Menu documentation site', 'http://www.phoca.cz/documentation/category/52-phoca-restaurant-menu-component');
				$links[]	= array('Phoca Restaurant Menu download site', 'http://www.phoca.cz/download/category/36-phoca-restaurant-menu-component');
			break;
