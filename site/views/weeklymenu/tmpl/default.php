...
echo '<div id="phocarestaurantmenu" class="weeklymenu'.$this->params->get( 'pageclass_sfx' ).'">';
...
echo PhocaMenuRenderViews::renderWeeklyMenu($this->data, $this->t, $this->params,$this->paramsg);
